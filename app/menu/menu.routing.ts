...
const menuRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path : 'public-game/single',  component : SingleGameSelection },
      { path : 'public-game/multiplayer',  component : MultiplayerGameSelection },
      { path : 'public-game/multiplayer/create',  component : CreateMultiplayerGame },
